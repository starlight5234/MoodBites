"""
Django settings for MoodBites project.
...
SECRET_KEY = 'django-insecure-sbulx@yj480-anodb%8ph(1fwu7z^rtbo=k_rt=ai+chfz^!^1'
...
WSGI_APPLICATION = 'MoodBites.wsgi.application'
